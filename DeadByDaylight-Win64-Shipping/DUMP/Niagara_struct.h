...
struct FNiagaraVariableBase {
	...
	struct FNiagaraTypeDefinitionHandle TypeDefHandle; // 0x0c(0x04)
};
...
struct FNiagaraBakerTextureSettings {
	...
	struct FNiagaraBakerTextureSource SourceBinding; // 0x0c(0x0c)
	char bUseFrameSize : 1; // 0x18(0x01)
	char pad_18_1 : 7; // 0x18(0x01)
	char pad_19[0x3]; // 0x19(0x03)
	struct FIntPoint FrameSize; // 0x1c(0x08)
	struct FIntPoint TextureSize; // 0x24(0x08)
	char pad_2C[0x4]; // 0x2c(0x04)
	struct UTexture2D* GeneratedTexture; // 0x30(0x08)
};
...
struct FNiagaraCompileDependency {
	...
	struct FNiagaraVariableBase DependentVariable; // 0x40(0x10)
};
...
struct FNiagaraMaterialAttributeBinding {
	struct FName MaterialParameterName; // 0x00(0x0c)
	struct FNiagaraVariableBase NiagaraVariable; // 0x0c(0x10)
	struct FNiagaraVariableBase ResolvedNiagaraVariable; // 0x1c(0x10)
	struct FNiagaraVariableBase NiagaraChildVariable; // 0x2c(0x10)
};

// ScriptStruct Niagara.NiagaraVariableAttributeBinding
// Size: 0x58 (Inherited: 0x00)
struct FNiagaraVariableAttributeBinding {
	struct FNiagaraVariableBase ParamMapVariable; // 0x00(0x10)
...
struct FNiagaraFunctionSignature {
	...
	char bRequiresExecPin : 1; // 0x3c(0x01)
	...
	char bSoftDeprecatedFunction : 1; // 0x3c(0x01)
	char bIsCompileTagGenerator : 1; // 0x3d(0x01)
	char bHidden : 1; // 0x3d(0x01)
	char pad_3D_2 : 6; // 0x3d(0x01)
	char pad_3E[0x2]; // 0x3e(0x02)
	int32_t ModuleUsageBitmask; // 0x40(0x04)
	int32_t ContextStageMinIndex; // 0x44(0x04)
	int32_t ContextStageMaxIndex; // 0x48(0x04)
	char pad_4C[0x4]; // 0x4c(0x04)
	struct TMap<struct FName, struct FName> FunctionSpecifiers; // 0x50(0x50)
};
...
struct FNiagaraComponentPropertyBinding {
	...
	struct FName PropertyName; // 0x58(0x0c)
	char pad_64[0x4]; // 0x64(0x04)
	struct FNiagaraTypeDefinition PropertyType; // 0x68(0x10)
	struct FName MetadataSetterName; // 0x78(0x0c)
	char pad_84[0x4]; // 0x84(0x04)
	struct TMap<struct FString, struct FString> PropertySetterParameterDefaults; // 0x88(0x50)
	struct FNiagaraVariable WritableValue; // 0xd8(0x20)
};
...
struct FNiagaraEmitterNameSettingsRef {
	...
	char pad_C[0x4]; // 0x0c(0x04)
	struct FString EmitterName; // 0x10(0x10)
};
...
struct FNiagaraDataSetCompiledData {
	...
	struct FNiagaraDataSetID ID; // 0x20(0x10)
	uint32_t TotalFloatComponents; // 0x30(0x04)
	uint32_t TotalInt32Components; // 0x34(0x04)
	uint32_t TotalHalfComponents; // 0x38(0x04)
	char bRequiresPersistentIDs : 1; // 0x3c(0x01)
	char pad_3C_1 : 7; // 0x3c(0x01)
	char pad_3D[0x3]; // 0x3d(0x03)
	enum class ENiagaraSimTarget SimTarget; // 0x40(0x01)
...
struct FNiagaraPlatformSetCVarCondition {
	struct FName CVarName; // 0x00(0x0c)
	bool value; // 0x0c(0x01)
	char pad_D[0x3]; // 0x0d(0x03)
	int32_t MinInt; // 0x10(0x04)
	int32_t MaxInt; // 0x14(0x04)
	float MinFloat; // 0x18(0x04)
	float MaxFloat; // 0x1c(0x04)
	char bUseMinInt : 1; // 0x20(0x01)
	char bUseMaxInt : 1; // 0x20(0x01)
	char bUseMinFloat : 1; // 0x20(0x01)
	char bUseMaxFloat : 1; // 0x20(0x01)
...
struct FNiagaraEventGeneratorProperties {
	...
	struct FNiagaraDataSetCompiledData DataSetCompiledData; // 0x10(0x48)
};
...
struct FNiagaraSystemCompiledData {
	...
	struct FNiagaraDataSetCompiledData DataSetCompiledData; // 0x78(0x48)
	struct FNiagaraDataSetCompiledData SpawnInstanceParamsDataSetCompiledData; // 0xc0(0x48)
	struct FNiagaraDataSetCompiledData UpdateInstanceParamsDataSetCompiledData; // 0x108(0x48)
	struct FNiagaraParameterDataSetBindingCollection SpawnInstanceGlobalBinding; // 0x150(0x20)
	struct FNiagaraParameterDataSetBindingCollection SpawnInstanceSystemBinding; // 0x170(0x20)
	struct FNiagaraParameterDataSetBindingCollection SpawnInstanceOwnerBinding; // 0x190(0x20)
	struct TArray<struct FNiagaraParameterDataSetBindingCollection> SpawnInstanceEmitterBindings; // 0x1b0(0x10)
	struct FNiagaraParameterDataSetBindingCollection UpdateInstanceGlobalBinding; // 0x1c0(0x20)
	struct FNiagaraParameterDataSetBindingCollection UpdateInstanceSystemBinding; // 0x1e0(0x20)
	struct FNiagaraParameterDataSetBindingCollection UpdateInstanceOwnerBinding; // 0x200(0x20)
	struct TArray<struct FNiagaraParameterDataSetBindingCollection> UpdateInstanceEmitterBindings; // 0x220(0x10)
};
...
struct FNiagaraEmitterCompiledData {
	...
	struct FNiagaraDataSetCompiledData DataSetCompiledData; // 0xf0(0x48)
};
...
struct FNiagaraVariableMetaData {
	...
	struct FName ParentAttribute; // 0xd0(0x0c)
	struct FGuid VariableGuid; // 0xdc(0x10)
	bool bIsStaticSwitch; // 0xec(0x01)
	char pad_ED[0x3]; // 0xed(0x03)
	int32_t StaticSwitchDefaultValue; // 0xf0(0x04)
