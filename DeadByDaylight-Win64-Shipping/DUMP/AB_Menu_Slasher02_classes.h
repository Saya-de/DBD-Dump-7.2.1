...
struct UAB_Menu_Slasher02_C : UBaseMenuAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function AB_Menu_Slasher02.AB_Menu_Slasher02_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x5e02c90
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function AB_Menu_Slasher02.AB_Menu_Slasher02_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x5e02c90
	void ExecuteUbergraph_AB_Menu_Slasher02(int32_t EntryPoint); // Function AB_Menu_Slasher02.AB_Menu_Slasher02_C.ExecuteUbergraph_AB_Menu_Slasher02 // (Final|UbergraphFunction) // @ game+0x5e02c90
};
