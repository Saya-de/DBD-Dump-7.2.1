...
struct FMovieSceneSubSequenceData {
	...
	struct FMovieSceneSequenceTransform RootToSequenceTransform; // 0x40(0x20)
	struct FFrameRate TickResolution; // 0x60(0x08)
	struct FMovieSceneSequenceID DeterministicSequenceID; // 0x68(0x04)
	struct FMovieSceneFrameRange ParentPlayRange; // 0x6c(0x10)
	struct FFrameNumber ParentStartFrameOffset; // 0x7c(0x04)
	struct FFrameNumber ParentEndFrameOffset; // 0x80(0x04)
	struct FFrameNumber ParentFirstLoopStartFrameOffset; // 0x84(0x04)
	bool bCanLoop; // 0x88(0x01)
	char pad_89[0x3]; // 0x89(0x03)
	struct FMovieSceneFrameRange PlayRange; // 0x8c(0x10)
	struct FMovieSceneFrameRange FullPlayRange; // 0x9c(0x10)
	struct FMovieSceneFrameRange UnwarpedPlayRange; // 0xac(0x10)
	struct FMovieSceneFrameRange PreRollRange; // 0xbc(0x10)
	struct FMovieSceneFrameRange PostRollRange; // 0xcc(0x10)
	int16_t HierarchicalBias; // 0xdc(0x02)
	bool bHasHierarchicalEasing; // 0xde(0x01)
	char pad_DF[0x1]; // 0xdf(0x01)
	struct FMovieSceneSequenceInstanceDataPtr InstanceData; // 0xe0(0x18)
	char pad_F8[0x8]; // 0xf8(0x08)
	struct FGuid SubSectionSignature; // 0x100(0x10)
};
