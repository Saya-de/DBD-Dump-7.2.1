...
struct UAB_Menu_Slasher06_C : UBaseMenuAnimInstance {
	...
	struct FAnimNode_RandomPlayer AnimGraphNode_RandomPlayer; // 0x3c0(0x78)
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function AB_Menu_Slasher06.AB_Menu_Slasher06_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x5e02c90
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function AB_Menu_Slasher06.AB_Menu_Slasher06_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x5e02c90
	void ExecuteUbergraph_AB_Menu_Slasher06(int32_t EntryPoint); // Function AB_Menu_Slasher06.AB_Menu_Slasher06_C.ExecuteUbergraph_AB_Menu_Slasher06 // (Final|UbergraphFunction) // @ game+0x5e02c90
};
