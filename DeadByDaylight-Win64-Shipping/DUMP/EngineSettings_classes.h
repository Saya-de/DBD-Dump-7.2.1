...
struct UGameMapsSettings : UObject {
	...
	void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer); // Function EngineSettings.GameMapsSettings.SetSkipAssigningGamepadToPlayer1 // (Final|Native|Public|BlueprintCallable) // @ game+0x666e890
	bool GetSkipAssigningGamepadToPlayer1(); // Function EngineSettings.GameMapsSettings.GetSkipAssigningGamepadToPlayer1 // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x666e860
	struct UGameMapsSettings* GetGameMapsSettings(); // Function EngineSettings.GameMapsSettings.GetGameMapsSettings // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x666e830
};
...
struct UGeneralProjectChunkingSettings : UObject {
	int32_t NumberOfPaksInInitialChunk; // 0x30(0x04)
	int32_t NumberOfPaksInAllChunks; // 0x34(0x04)
	int32_t LeftoverPakId; // 0x38(0x04)
	char pad_3C[0x4]; // 0x3c(0x04)
	struct TArray<struct FPathPak> PakAssignmentPaths; // 0x40(0x10)
	struct TArray<struct FPakDefinition> PakDefinitions; // 0x50(0x10)
	int32_t AtlantaNumberOfPaksInInitialChunk; // 0x60(0x04)
	int32_t AtlantaAndroidNumberOfPaksInAllChunks; // 0x64(0x04)
	int32_t AtlantaIOSNumberOfPaksInAllChunks; // 0x68(0x04)
	int32_t AtlantaLeftoverPakId; // 0x6c(0x04)
	struct TArray<struct FPathPak> AtlantaPakAssignmentPaths; // 0x70(0x10)
	struct TArray<struct FPathPak> AtlantaAndroidPakAssignmentPaths; // 0x80(0x10)
	struct TArray<struct FPathPak> AtlantaIOSPakAssignmentPaths; // 0x90(0x10)
