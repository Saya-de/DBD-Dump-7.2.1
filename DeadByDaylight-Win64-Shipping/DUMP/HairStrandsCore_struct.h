...
struct FHairGroupsMaterial {
	...
	struct FName SlotName; // 0x08(0x0c)
...
struct FHairGroupsCardsSourceDescription {
	...
	enum class EHairCardsSourceType SourceType; // 0x14(0x01)
...
struct FHairGroupsMeshesSourceDescription {
	...
	struct FName MaterialSlotName; // 0x08(0x0c)
	char pad_14[0x4]; // 0x14(0x04)
	struct UStaticMesh* ImportedMesh; // 0x18(0x08)
	struct FHairGroupCardsTextures Textures; // 0x20(0x30)
...
struct FHairGroupsPhysics {
	struct FHairSolverSettings SolverSettings; // 0x00(0x40)
	struct FHairExternalForces ExternalForces; // 0x40(0x1c)
	char pad_5C[0x4]; // 0x5c(0x04)
	struct FHairMaterialConstraints MaterialConstraints; // 0x60(0x1d8)
	struct FHairStrandsParameters StrandsParameters; // 0x238(0x98)
};
...
struct FHairSolverSettings {
	...
	struct TSoftObjectPtr<UNiagaraSystem> CustomSystem; // 0x08(0x30)
	int32_t SubSteps; // 0x38(0x04)
	int32_t IterationCount; // 0x3c(0x04)
};
...
struct FHairGroupsRendering {
	...
	struct FHairGeometrySettings GeometrySettings; // 0x18(0x10)
	struct FHairShadowSettings ShadowSettings; // 0x28(0x0c)
	struct FHairAdvancedRenderingSettings AdvancedSettings; // 0x34(0x02)
...
struct FGroomCacheImportSettings {
	...
	char pad_2[0x6]; // 0x02(0x06)
	struct FSoftObjectPath GroomAsset; // 0x08(0x20)
};
