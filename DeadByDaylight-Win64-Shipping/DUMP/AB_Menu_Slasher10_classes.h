...
struct UAB_Menu_Slasher10_C : UBaseMenuAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function AB_Menu_Slasher10.AB_Menu_Slasher10_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x5e02c90
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function AB_Menu_Slasher10.AB_Menu_Slasher10_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x5e02c90
	void ExecuteUbergraph_AB_Menu_Slasher10(int32_t EntryPoint); // Function AB_Menu_Slasher10.AB_Menu_Slasher10_C.ExecuteUbergraph_AB_Menu_Slasher10 // (Final|UbergraphFunction) // @ game+0x5e02c90
};
