...
struct UAB_Menu_Slasher04_C : UBaseMenuAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function AB_Menu_Slasher04.AB_Menu_Slasher04_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x5e02c90
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function AB_Menu_Slasher04.AB_Menu_Slasher04_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x5e02c90
	void ExecuteUbergraph_AB_Menu_Slasher04(int32_t EntryPoint); // Function AB_Menu_Slasher04.AB_Menu_Slasher04_C.ExecuteUbergraph_AB_Menu_Slasher04 // (Final|UbergraphFunction) // @ game+0x5e02c90
};
