...
struct FAnimNode_AimOffsetLookAt : FAnimNode_BlendSpacePlayer {
	...
	struct FName SourceSocketName; // 0x164(0x0c)
	struct FName PivotSocketName; // 0x170(0x0c)
	struct FVector LookAtLocation; // 0x17c(0x0c)
	struct FVector SocketAxis; // 0x188(0x0c)
	float alpha; // 0x194(0x04)
	char pad_198[0x38]; // 0x198(0x38)
};
...
struct FAnimNode_AnimDynamics : FAnimNode_SkeletalControlBase {
	...
	bool bHardLinkChain; // 0x154(0x01)
	char pad_155[0x3]; // 0x155(0x03)
	struct FBoneReference BoundBone; // 0x158(0x14)
	struct FBoneReference ChainEnd; // 0x16c(0x14)
	struct FVector BoxExtents; // 0x180(0x0c)
	struct FVector LocalJointOffset; // 0x18c(0x0c)
	float GravityScale; // 0x198(0x04)
	struct FVector GravityOverride; // 0x19c(0x0c)
	float LinearSpringConstant; // 0x1a8(0x04)
	float AngularSpringConstant; // 0x1ac(0x04)
	float WindScale; // 0x1b0(0x04)
	struct FVector ComponentLinearAccScale; // 0x1b4(0x0c)
	struct FVector ComponentLinearVelScale; // 0x1c0(0x0c)
	struct FVector ComponentAppliedLinearAccClamp; // 0x1cc(0x0c)
	float AngularBiasOverride; // 0x1d8(0x04)
	int32_t NumSolverIterationsPreUpdate; // 0x1dc(0x04)
	int32_t NumSolverIterationsPostUpdate; // 0x1e0(0x04)
	struct FAnimPhysConstraintSetup ConstraintSetup; // 0x1e4(0x48)
	char pad_22C[0x4]; // 0x22c(0x04)
	struct TArray<struct FAnimPhysSphericalLimit> SphericalLimits; // 0x230(0x10)
	float SphereCollisionRadius; // 0x240(0x04)
	struct FVector ExternalForce; // 0x244(0x0c)
	struct TArray<struct FAnimPhysPlanarLimit> PlanarLimits; // 0x250(0x10)
	enum class AnimPhysCollisionType CollisionType; // 0x260(0x01)
	enum class AnimPhysSimSpaceType SimulationSpace; // 0x261(0x01)
	char pad_262[0x2]; // 0x262(0x02)
	char bUseSphericalLimits : 1; // 0x264(0x01)
	char bUsePlanarLimit : 1; // 0x264(0x01)
	char bDoUpdate : 1; // 0x264(0x01)
	char bDoEval : 1; // 0x264(0x01)
	char bOverrideLinearDamping : 1; // 0x264(0x01)
	char bOverrideAngularBias : 1; // 0x264(0x01)
	char bOverrideAngularDamping : 1; // 0x264(0x01)
	char bEnableWind : 1; // 0x264(0x01)
	char pad_265_0 : 1; // 0x265(0x01)
	char bUseGravityOverride : 1; // 0x265(0x01)
	char bLinearSpring : 1; // 0x265(0x01)
	char bAngularSpring : 1; // 0x265(0x01)
	char bChain : 1; // 0x265(0x01)
	char pad_265_5 : 3; // 0x265(0x01)
	char pad_266[0xa]; // 0x266(0x0a)
	struct FRotationRetargetingInfo RetargetingSettings; // 0x270(0x130)
...
struct FAnimNode_RigidBody : FAnimNode_SkeletalControlBase {
	...
	char pad_21C[0x634]; // 0x21c(0x634)
};
...
struct FAnimNode_RotationOffsetBlendSpace : FAnimNode_BlendSpacePlayer {
	...
	struct FName AlphaCurveName; // 0x150(0x0c)
	struct FInputScaleBiasClamp AlphaScaleBiasClamp; // 0x15c(0x30)
	char pad_18C[0x4]; // 0x18c(0x04)
	enum class EAnimAlphaInputType AlphaInputType; // 0x190(0x01)
	bool bAlphaBoolEnabled; // 0x191(0x01)
...
struct FAnimSequencerInstanceProxy : FAnimInstanceProxy {
	char pad_770[0x2c0]; // 0x770(0x2c0)
};
