...
struct UBaseBrushTool : UMeshSurfacePointTool {
	...
	struct FBrushStampData LastBrushStamp; // 0xd8(0xb0)
...
struct UGizmoBaseComponent : UPrimitiveComponent {
	...
	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // @ game+0x8122510
	void UpdateHoverState(bool bHoveringIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState // (Final|Native|Public) // @ game+0x8122480
};
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform& NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // @ game+0x81223a0
	struct FTransform GetTransform(); // Function InteractiveToolsFramework.GizmoTransformSource.GetTransform // (Native|Public|HasDefaults|Const) // @ game+0x8122270
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (Native|Public|Const) // @ game+0x81222e0
	void GetTangentVectors(struct FVector& TangentXOut, struct FVector& TangentYOut); // Function InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors // (Native|Public|HasOutParms|HasDefaults|Const) // @ game+0x8122180
	struct FVector GetOrigin(); // Function InteractiveToolsFramework.GizmoAxisSource.GetOrigin // (Native|Public|HasDefaults|Const) // @ game+0x7e69b80
	struct FVector GetDirection(); // Function InteractiveToolsFramework.GizmoAxisSource.GetDirection // (Native|Public|HasDefaults|Const) // @ game+0x81220d0
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public|Const) // @ game+0x46aaa30
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // @ game+0x46b7690
	void BeginUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.BeginUpdate // (Native|Public) // @ game+0x46b1900
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Native|Public) // @ game+0x46d5230
	float GetParameter(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.GetParameter // (Native|Public|Const) // @ game+0x8122110
	void EndModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.EndModify // (Native|Public) // @ game+0x46b7550
	void BeginModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.BeginModify // (Native|Public) // @ game+0x46b7690
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D& NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Native|Public|HasOutParms|HasDefaults) // @ game+0x8122310
	struct FVector2D GetParameter(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter // (Native|Public|HasDefaults|Const) // @ game+0x8122140
	void EndModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.EndModify // (Native|Public) // @ game+0x46b7550
	void BeginModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.BeginModify // (Native|Public) // @ game+0x46b7690
};
...
struct AIntervalGizmoActor : AGizmoActor {
	struct UGizmoLineHandleComponent* UpIntervalComponent; // 0x230(0x08)
	struct UGizmoLineHandleComponent* DownIntervalComponent; // 0x238(0x08)
	struct UGizmoLineHandleComponent* ForwardIntervalComponent; // 0x240(0x08)
};
...
struct ATransformGizmoActor : AGizmoActor {
	struct UPrimitiveComponent* TranslateX; // 0x230(0x08)
	struct UPrimitiveComponent* TranslateY; // 0x238(0x08)
	struct UPrimitiveComponent* TranslateZ; // 0x240(0x08)
	struct UPrimitiveComponent* TranslateYZ; // 0x248(0x08)
	struct UPrimitiveComponent* TranslateXZ; // 0x250(0x08)
	struct UPrimitiveComponent* TranslateXY; // 0x258(0x08)
	struct UPrimitiveComponent* RotateX; // 0x260(0x08)
	struct UPrimitiveComponent* RotateY; // 0x268(0x08)
	struct UPrimitiveComponent* RotateZ; // 0x270(0x08)
	struct UPrimitiveComponent* UniformScale; // 0x278(0x08)
	struct UPrimitiveComponent* AxisScaleX; // 0x280(0x08)
	struct UPrimitiveComponent* AxisScaleY; // 0x288(0x08)
	struct UPrimitiveComponent* AxisScaleZ; // 0x290(0x08)
	struct UPrimitiveComponent* PlaneScaleYZ; // 0x298(0x08)
	struct UPrimitiveComponent* PlaneScaleXZ; // 0x2a0(0x08)
	struct UPrimitiveComponent* PlaneScaleXY; // 0x2a8(0x08)
};
