...
struct FWindowStyle : FSlateWidgetStyle {
	...
	struct FTextBlockStyle TitleTextStyle; // 0xaa8(0x288)
	struct FSlateBrush ActiveTitleBrush; // 0xd30(0x90)
	struct FSlateBrush InactiveTitleBrush; // 0xdc0(0x90)
	struct FSlateBrush FlashTitleBrush; // 0xe50(0x90)
	struct FSlateColor BackgroundColor; // 0xee0(0x28)
	struct FSlateBrush OutlineBrush; // 0xf08(0x90)
	struct FSlateColor OutlineColor; // 0xf98(0x28)
	struct FSlateBrush BorderBrush; // 0xfc0(0x90)
	struct FSlateBrush BackgroundBrush; // 0x1050(0x90)
	struct FSlateBrush ChildBackgroundBrush; // 0x10e0(0x90)
};
...
struct FHyperlinkStyle : FSlateWidgetStyle {
	...
	struct FTextBlockStyle TextStyle; // 0x2b0(0x288)
	struct FMargin Padding; // 0x538(0x10)
};
