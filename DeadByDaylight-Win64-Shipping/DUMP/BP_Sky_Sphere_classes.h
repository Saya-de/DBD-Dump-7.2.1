...
struct ABP_Sky_Sphere_C : AActor {
	...
	void RefreshMaterial(); // Function BP_Sky_Sphere.BP_Sky_Sphere_C.RefreshMaterial // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x5e02c90
	void UpdateSunDirection(); // Function BP_Sky_Sphere.BP_Sky_Sphere_C.UpdateSunDirection // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x5e02c90
	void UserConstructionScript(); // Function BP_Sky_Sphere.BP_Sky_Sphere_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x5e02c90
};
