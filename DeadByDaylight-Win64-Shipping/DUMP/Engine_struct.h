...
enum class EViewModeIndex : uint8 {
	...
	VMI_MaterialCategoriesBHVR = 29,
	VMI_SmallTriangleBHVR = 30,
	VMI_Max = 31,
	VMI_Unknown = 255,
	VMI_Max = 256
};
...
// Enum Engine.ECustomDecalBlendModeChannels
enum class ECustomDecalBlendModeChannels : uint8 {
	None = 0,
	BaseColor = 1,
	Normal = 2,
	Emissive = 4,
	...
	Specular = 16,
	Roughness = 32,
	ECustomDecalBlendModeChannels_MAX = 33
};
...
enum class ESceneTextureId : uint8 {
	...
	PPI_WorldTangent = 29,
	PPI_Anisotropy = 30,
	PPI_BasePassDepthStencilCopy = 31,
	PPI_MAX = 32
};
...
enum class EDetailModeBitMask : uint8 {
	DMBM_PC = 0,
	DMBM_Console = 1,
	DMBM_Atlanta = 2,
	DMBM_Switch = 3,
...
enum class ELightingDetailMode : uint8 {
	Low = 50,
	Medium = 100,
	High = 150,
	ELightingDetailMode_MAX = 151
};
...
// Enum Engine.ELightmapGenerationMode
enum class ELightmapGenerationMode : uint8 {
	Default = 0,
	SharedLOD0 = 1,
...
enum class EBatchingMode : uint8 {
	None = 0,
	Instanced = 1,
	Hierarchical = 2,
	GPUCulling = 3,
...
struct FExpressionInput {
	...
	struct FName InputName; // 0x04(0x0c)
	struct FName ExpressionName; // 0x10(0x0c)
};

// ScriptStruct Engine.MaterialAttributesInput
// Size: 0x20 (Inherited: 0x1c)
struct FMaterialAttributesInput : FExpressionInput {
	int32_t PropertyConnectedBitmask; // 0x1c(0x04)
};
...
struct FFindFloorResult {
	...
	struct FHitResult HitResult; // 0x0c(0x90)
};
...
struct FHeightFogGradientEntry {
	struct FLinearColor Colour; // 0x00(0x10)
	float GradientHeight; // 0x10(0x04)
};
...
struct FPrimaryAssetRulesOverride {
	...
	struct FPrimaryAssetRules Rules; // 0x18(0x0c)
};
...
struct FPrimaryAssetTypeInfo {
	...
	struct FPrimaryAssetRules Rules; // 0x70(0x0c)
	char pad_7C[0x4]; // 0x7c(0x04)
	struct TArray<struct FString> AssetScanPaths; // 0x80(0x10)
	bool bIsDynamicAsset; // 0x90(0x01)
	char pad_91[0x3]; // 0x91(0x03)
	int32_t NumberOfAssets; // 0x94(0x04)
};
...
struct FDefaultAudioBusSettings {
	struct FSoftObjectPath AudioBus; // 0x00(0x20)
};
...
struct FSoundDebugEntry {
	...
	char pad_C[0x4]; // 0x0c(0x04)
	struct FSoftObjectPath Sound; // 0x10(0x20)
};
...
// ScriptStruct Engine.BHVRPerDetailModeBool
// Size: 0xa0 (Inherited: 0x00)
struct FBHVRPerDetailModeBool {
	struct TMap<struct FName, bool> PerDetailModeValue; // 0x00(0x50)
	struct TMap<struct FName, bool> PerDetailModeOverride; // 0x50(0x50)
};

// ScriptStruct Engine.BHVRPerDetailModeFloat
// Size: 0xa0 (Inherited: 0x00)
struct FBHVRPerDetailModeFloat {
	struct TMap<struct FName, float> PerDetailModeValue; // 0x00(0x50)
	struct TMap<struct FName, bool> PerDetailModeOverride; // 0x50(0x50)
};

// ScriptStruct Engine.BHVRPerDetailModeInt
// Size: 0xa0 (Inherited: 0x00)
struct FBHVRPerDetailModeInt {
	struct TMap<struct FName, int32_t> PerDetailModeValue; // 0x00(0x50)
	struct TMap<struct FName, bool> PerDetailModeOverride; // 0x50(0x50)
};
...
struct FPostProcessSettings {
	...
	enum class ETemperatureMethod TemperatureType; // 0x23(0x01)
	...
	float PathTracingFilterWidth; // 0x530(0x04)
	char PathTracingEnableEmissive : 1; // 0x534(0x01)
	char pad_534_1 : 7; // 0x534(0x01)
	char pad_535[0x3]; // 0x535(0x03)
	float PathTracingMaxPathExposure; // 0x538(0x04)
	char PathTracingEnableDenoiser : 1; // 0x53c(0x01)
	char pad_53C_1 : 7; // 0x53c(0x01)
	char pad_53D[0x3]; // 0x53d(0x03)
	float LPVFadeRange; // 0x540(0x04)
	float LPVDirectionalOcclusionFadeRange; // 0x544(0x04)
	float ScreenPercentage; // 0x548(0x04)
...
struct FConstraintInstance : FConstraintInstanceBase {
	...
	struct FConstraintProfileProperties ProfileInstance; // 0x98(0x114)
...
struct FAnimUpdateRateParameters {
	...
	struct TMap<int32_t, float> AnimationFrameSkipToTreshold; // 0x30(0x50)
	struct TMap<int32_t, int32_t> LODToFrameSkipMap; // 0x80(0x50)
	int32_t SkippedUpdateFrames; // 0xd0(0x04)
	int32_t SkippedEvalFrames; // 0xd4(0x04)
};
...
struct FPredictProjectilePathResult {
	...
	struct FHitResult HitResult; // 0x2c(0x90)
	char pad_BC[0x4]; // 0xbc(0x04)
};
...
struct FMaterialConfig {
	struct TArray<struct UMaterialInterface*> MaterialPerSection; // 0x00(0x10)
};
...
struct FCustomInput {
	...
	struct FExpressionInput Input; // 0x0c(0x1c)
};
...
struct FFunctionExpressionInput {
	...
	struct FExpressionInput Input; // 0x18(0x1c)
	char pad_34[0x4]; // 0x34(0x04)
};
...
struct FMaterialInstanceBasePropertyOverrides {
	...
	char bOverride_CastMaskedMaterialShadow : 1; // 0x00(0x01)
	char bOverride_CastTranslucentShadowsAsOpaque : 1; // 0x00(0x01)
	char bOverride_IsGroundTagged : 1; // 0x00(0x01)
	char bIsGroundTagged : 1; // 0x00(0x01)
	char bOverride_IsEmissiveExposureIndependent : 1; // 0x01(0x01)
	...
	char CastMaskedMaterialShadow : 1; // 0x01(0x01)
	char bCastTranslucentShadowsAsOpaque : 1; // 0x01(0x01)
	char bIsEmissiveExposureIndependent : 1; // 0x01(0x01)
	char bCastDynamicShadowAsMasked : 1; // 0x02(0x01)
	char pad_2_1 : 7; // 0x02(0x01)
	enum class EBlendMode BlendMode; // 0x03(0x01)
	enum class EMaterialShadingModel ShadingModel; // 0x04(0x01)
	char pad_5[0x3]; // 0x05(0x03)
...
struct FPhysicsConstraintProfileHandle {
	...
	struct FName ProfileName; // 0x114(0x0c)
};
...
struct FTresholdToFrameSkip {
	struct FPerPlatformFloat Treshold; // 0x00(0x04)
	struct FPerPlatformInt FrameSkip; // 0x04(0x04)
};
...
struct FTextureLODGroup {
	...
	bool HighPriorityLoad; // 0x59(0x01)
	bool DuplicateNonOptionalMips; // 0x5a(0x01)
	...
	enum class ETextureLossyCompressionAmount LossyCompressionAmount; // 0x6c(0x01)
	char pad_6D[0x3]; // 0x6d(0x03)
};
...
struct FTimeline {
	...
	struct FDelegate TimelinePostUpdateFunc; // 0x50(0x14)
	struct FDelegate TimelineFinishedFunc; // 0x64(0x14)
	struct TWeakObjectPtr<struct UObject> PropertySetObject; // 0x78(0x08)
	struct FName DirectionPropertyName; // 0x80(0x0c)
