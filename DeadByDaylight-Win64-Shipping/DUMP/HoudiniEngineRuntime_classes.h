...
struct AHoudiniAssetActor : AActor {
	struct UHoudiniAssetComponent* HoudiniAssetComponent; // 0x230(0x08)
};

// Class HoudiniEngineRuntime.HoudiniAssetComponent
// Size: 0x8d0 (Inherited: 0x480)
struct UHoudiniAssetComponent : UPrimitiveComponent {
	char pad_480[0x8]; // 0x480(0x08)
	struct UHoudiniAsset* HoudiniAsset; // 0x488(0x08)
	bool bCookOnParameterChange; // 0x490(0x01)
	bool bUploadTransformsToHoudiniEngine; // 0x491(0x01)
	bool bCookOnTransformChange; // 0x492(0x01)
	bool bCookOnAssetInputCook; // 0x493(0x01)
	bool bOutputless; // 0x494(0x01)
	bool bOutputTemplateGeos; // 0x495(0x01)
	bool bUseOutputNodes; // 0x496(0x01)
	char pad_497[0x1]; // 0x497(0x01)
	struct FDirectoryPath TemporaryCookFolder; // 0x498(0x10)
	struct FDirectoryPath BakeFolder; // 0x4a8(0x10)
	enum class EHoudiniStaticMeshMethod StaticMeshMethod; // 0x4b8(0x01)
	char pad_4B9[0x7]; // 0x4b9(0x07)
	struct FHoudiniStaticMeshGenerationProperties StaticMeshGenerationProperties; // 0x4c0(0x1b0)
	struct FMeshBuildSettings StaticMeshBuildSettings; // 0x670(0x30)
	bool bOverrideGlobalProxyStaticMeshSettings; // 0x6a0(0x01)
	bool bEnableProxyStaticMeshOverride; // 0x6a1(0x01)
	bool bEnableProxyStaticMeshRefinementByTimerOverride; // 0x6a2(0x01)
	char pad_6A3[0x1]; // 0x6a3(0x01)
	float ProxyMeshAutoRefineTimeoutSecondsOverride; // 0x6a4(0x04)
	bool bEnableProxyStaticMeshRefinementOnPreSaveWorldOverride; // 0x6a8(0x01)
	bool bEnableProxyStaticMeshRefinementOnPreBeginPIEOverride; // 0x6a9(0x01)
	char pad_6AA[0x2]; // 0x6aa(0x02)
	int32_t AssetId; // 0x6ac(0x04)
	struct TArray<int32_t> NodeIdsToCook; // 0x6b0(0x10)
	struct TSet<struct UHoudiniAssetComponent*> DownstreamHoudiniAssets; // 0x6c0(0x50)
	struct FGuid ComponentGUID; // 0x710(0x10)
	struct FGuid HapiGUID; // 0x720(0x10)
	struct FString HapiAssetName; // 0x730(0x10)
	enum class EHoudiniAssetState AssetState; // 0x740(0x01)
	enum class EHoudiniAssetState DebugLastAssetState; // 0x741(0x01)
	enum class EHoudiniAssetStateResult AssetStateResult; // 0x742(0x01)
	char pad_743[0x1]; // 0x743(0x01)
	uint32_t SubAssetIndex; // 0x744(0x04)
	int32_t AssetCookCount; // 0x748(0x04)
	bool bHasBeenLoaded; // 0x74c(0x01)
	bool bHasBeenDuplicated; // 0x74d(0x01)
	bool bPendingDelete; // 0x74e(0x01)
	bool bRecookRequested; // 0x74f(0x01)
	bool bRebuildRequested; // 0x750(0x01)
	bool bEnableCooking; // 0x751(0x01)
	bool bForceNeedUpdate; // 0x752(0x01)
	bool bLastCookSuccess; // 0x753(0x01)
	bool bParameterDefinitionUpdateNeeded; // 0x754(0x01)
	bool bBlueprintStructureModified; // 0x755(0x01)
	bool bBlueprintModified; // 0x756(0x01)
	char pad_757[0x1]; // 0x757(0x01)
	struct TArray<struct UHoudiniParameter*> Parameters; // 0x758(0x10)
	struct TArray<struct UHoudiniInput*> Inputs; // 0x768(0x10)
	struct TArray<struct UHoudiniOutput*> Outputs; // 0x778(0x10)
	struct TArray<struct FHoudiniBakedOutput> BakedOutputs; // 0x788(0x10)
	struct TArray<struct TWeakObjectPtr<struct AActor>> UntrackedOutputs; // 0x798(0x10)
	struct TArray<struct UHoudiniHandleComponent*> HandleComponents; // 0x7a8(0x10)
	bool bHasComponentTransformChanged; // 0x7b8(0x01)
	bool bFullyLoaded; // 0x7b9(0x01)
	char pad_7BA[0x6]; // 0x7ba(0x06)
	struct UHoudiniPDGAssetLink* PDGAssetLink; // 0x7c0(0x08)
	struct FTimerHandle RefineMeshesTimer; // 0x7c8(0x08)
	char pad_7D0[0x18]; // 0x7d0(0x18)
	bool bNoProxyMeshNextCookRequested; // 0x7e8(0x01)
	char pad_7E9[0x7]; // 0x7e9(0x07)
	struct TMap<struct UObject*, int32_t> InputPresets; // 0x7f0(0x50)
	bool bBakeAfterNextCook; // 0x840(0x01)
	char pad_841[0x5f]; // 0x841(0x5f)
	bool bCachedIsPreview; // 0x8a0(0x01)
	char pad_8A1[0xf]; // 0x8a1(0x0f)
	double LastTickTime; // 0x8b0(0x08)
	char pad_8B8[0x18]; // 0x8b8(0x18)
};

// Class HoudiniEngineRuntime.HoudiniAssetBlueprintComponent
// Size: 0x9d0 (Inherited: 0x8d0)
struct UHoudiniAssetBlueprintComponent : UHoudiniAssetComponent {
	char pad_8D0[0x48]; // 0x8d0(0x48)
	bool FauxBPProperty; // 0x918(0x01)
	bool bHoudiniAssetChanged; // 0x919(0x01)
	bool bUpdatedFromTemplate; // 0x91a(0x01)
	bool bIsInBlueprintEditor; // 0x91b(0x01)
	bool bCanDeleteHoudiniNodes; // 0x91c(0x01)
	bool bHasRegisteredComponentTemplate; // 0x91d(0x01)
	char pad_91E[0xa]; // 0x91e(0x0a)
	struct TMap<struct FHoudiniOutputObjectIdentifier, struct FGuid> CachedOutputNodes; // 0x928(0x50)
	struct TMap<struct FGuid, struct FGuid> CachedInputNodes; // 0x978(0x50)
	char pad_9C8[0x8]; // 0x9c8(0x08)

	void SetToggleValueAt(struct FString Name, bool value, int32_t index); // Function HoudiniEngineRuntime.HoudiniAssetBlueprintComponent.SetToggleValueAt // (Final|Native|Public|BlueprintCallable) // @ game+0x3fc6410
	void SetFloatParameter(struct FString Name, float value, int32_t index); // Function HoudiniEngineRuntime.HoudiniAssetBlueprintComponent.SetFloatParameter // (Final|Native|Public|BlueprintCallable) // @ game+0x3fc62b0
	bool HasParameter(struct FString Name); // Function HoudiniEngineRuntime.HoudiniAssetBlueprintComponent.HasParameter // (Final|Native|Public|BlueprintCallable) // @ game+0x3fc61b0
};
...
// Size: 0x9a0 (Inherited: 0x480)
struct UHoudiniAssetComponent_V1 : UPrimitiveComponent {
	char bGeneratedDoubleSidedGeometry : 1; // 0x480(0x01)
	char pad_480_1 : 7; // 0x480(0x01)
	char pad_481[0x7]; // 0x481(0x07)
	struct UPhysicalMaterial* GeneratedPhysMaterial; // 0x488(0x08)
	struct FBodyInstance DefaultBodyInstance; // 0x490(0x160)
	...
	float GeneratedDistanceFieldResolutionScale; // 0x5f8(0x04)
	struct FWalkableSlopeOverride GeneratedWalkableSlopeOverride; // 0x5fc(0x10)
	int32_t GeneratedLightMapCoordinateIndex; // 0x60c(0x04)
	char bGeneratedUseMaximumStreamingTexelRatio : 1; // 0x610(0x01)
	char pad_610_1 : 7; // 0x610(0x01)
	char pad_611[0x3]; // 0x611(0x03)
	float GeneratedStreamingDistanceMultiplier; // 0x614(0x04)
	struct UFoliageType_InstancedStaticMesh* GeneratedFoliageDefaultSettings; // 0x618(0x08)
	struct TArray<struct UAssetUserData*> GeneratedAssetUserData; // 0x620(0x10)
	struct FText BakeFolder; // 0x630(0x18)
	struct FText TempCookFolder; // 0x648(0x18)
	char pad_660[0x340]; // 0x660(0x340)
};
...
struct UHoudiniHandleComponent : USceneComponent {
	struct TArray<struct UHoudiniHandleParameter*> XformParms; // 0x218(0x10)
	struct UHoudiniHandleParameter* RSTParm; // 0x228(0x08)
	struct UHoudiniHandleParameter* RotOrderParm; // 0x230(0x08)
	enum class EHoudiniHandleType HandleType; // 0x238(0x01)
	struct FString HandleName; // 0x240(0x10)
};
...
struct UHoudiniInstancedActorComponent : USceneComponent {
	struct UObject* InstancedObject; // 0x218(0x08)
	struct TArray<struct AActor*> InstancedActors; // 0x220(0x10)
};
...
struct UHoudiniMeshSplitInstancerComponent : USceneComponent {
	...
	struct TArray<struct UMaterialInterface*> OverrideMaterials; // 0x228(0x10)
	struct UStaticMesh* InstancedMesh; // 0x238(0x08)
};
...
// Size: 0x4b0 (Inherited: 0x220)
struct UHoudiniSplineComponent : USceneComponent {
	struct TArray<struct FTransform> CurvePoints; // 0x220(0x10)
	struct TArray<struct FVector> DisplayPoints; // 0x230(0x10)
	struct TArray<int32_t> DisplayPointIndexDivider; // 0x240(0x10)
	struct FString HoudiniSplineName; // 0x250(0x10)
	bool bClosed; // 0x260(0x01)
	bool bReversed; // 0x261(0x01)
	bool bIsHoudiniSplineVisible; // 0x262(0x01)
	enum class EHoudiniCurveType CurveType; // 0x263(0x01)
	enum class EHoudiniCurveMethod CurveMethod; // 0x264(0x01)
	bool bIsOutputCurve; // 0x265(0x01)
	bool bCookOnCurveChanged; // 0x266(0x01)
	char pad_267[0x229]; // 0x267(0x229)
	bool bHasChanged; // 0x490(0x01)
	bool bNeedsToTriggerUpdate; // 0x491(0x01)
	bool bIsInputCurve; // 0x492(0x01)
	bool bIsEditableOutputCurve; // 0x493(0x01)
	int32_t NodeId; // 0x494(0x04)
	struct FString PartName; // 0x498(0x10)
...
struct UHoudiniStaticMesh : UObject {
	...
	void SetVertexPosition(uint32_t InVertexIndex, struct FVector& InPosition); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetVertexPosition // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x3fcf130
	void SetTriangleVertexVTangent(uint32_t InTriangleIndex, char InTriangleVertexIndex, struct FVector& InVTangent); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexVTangent // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x3fcf010
	void SetTriangleVertexUV(uint32_t InTriangleIndex, char InTriangleVertexIndex, char InUVLayer, struct FVector2D& InUV); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexUV // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x3fceeb0
	void SetTriangleVertexUTangent(uint32_t InTriangleIndex, char InTriangleVertexIndex, struct FVector& InUTangent); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexUTangent // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x3fced90
	void SetTriangleVertexNormal(uint32_t InTriangleIndex, char InTriangleVertexIndex, struct FVector& InNormal); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexNormal // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x3fcec70
	void SetTriangleVertexIndices(uint32_t InTriangleIndex, struct FIntVector& InTriangleVertexIndices); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexIndices // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x3fceba0
	void SetTriangleVertexColor(uint32_t InTriangleIndex, char InTriangleVertexIndex, struct FColor& InColor); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleVertexColor // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x3fcea80
	void SetTriangleMaterialID(uint32_t InTriangleIndex, int32_t InMaterialID); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetTriangleMaterialID // (Final|Native|Public) // @ game+0x3fce9b0
	void SetStaticMaterial(uint32_t InMaterialIndex, struct FStaticMaterial& InStaticMaterial); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetStaticMaterial // (Final|Native|Public|HasOutParms) // @ game+0x3fce8a0
	void SetNumUVLayers(uint32_t InNumUVLayers); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetNumUVLayers // (Final|Native|Public) // @ game+0x3fce810
	void SetNumStaticMaterials(uint32_t InNumStaticMaterials); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetNumStaticMaterials // (Final|Native|Public) // @ game+0x3fce780
	void SetHasTangents(bool bInHasTangents); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetHasTangents // (Final|Native|Public) // @ game+0x3fce6f0
	void SetHasPerFaceMaterials(bool bInHasPerFaceMaterials); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetHasPerFaceMaterials // (Final|Native|Public) // @ game+0x3fce660
	void SetHasNormals(bool bInHasNormals); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetHasNormals // (Final|Native|Public) // @ game+0x3fce5d0
	void SetHasColors(bool bInHasColors); // Function HoudiniEngineRuntime.HoudiniStaticMesh.SetHasColors // (Final|Native|Public) // @ game+0x3fce540
	void Optimize(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.Optimize // (Final|Native|Public) // @ game+0x3fce520
	bool IsValid(bool bInSkipVertexIndicesCheck); // Function HoudiniEngineRuntime.HoudiniStaticMesh.IsValid // (Final|Native|Public|Const) // @ game+0x3fce480
	void Initialize(uint32_t InNumVertices, uint32_t InNumTriangles, uint32_t InNumUVLayers, uint32_t InInitialNumStaticMaterials, bool bInHasNormals, bool bInHasTangents, bool bInHasColors, bool bInHasPerFaceMaterials); // Function HoudiniEngineRuntime.HoudiniStaticMesh.Initialize // (Final|Native|Public) // @ game+0x3fce210
	bool HasTangents(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.HasTangents // (Final|Native|Public|Const) // @ game+0x3fce1f0
	bool HasPerFaceMaterials(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.HasPerFaceMaterials // (Final|Native|Public|Const) // @ game+0x3fce1d0
	bool HasNormals(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.HasNormals // (Final|Native|Public|Const) // @ game+0x3fce1b0
	bool HasColors(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.HasColors // (Final|Native|Public|Const) // @ game+0x3fce190
	struct TArray<struct FVector> GetVertexPositions(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexPositions // (Final|Native|Public|Const) // @ game+0x3fce160
	struct TArray<struct FVector> GetVertexInstanceVTangents(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceVTangents // (Final|Native|Public|Const) // @ game+0x3fce130
	struct TArray<struct FVector2D> GetVertexInstanceUVs(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceUVs // (Final|Native|Public|Const) // @ game+0x3fce0a0
	struct TArray<struct FVector> GetVertexInstanceUTangents(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceUTangents // (Final|Native|Public|Const) // @ game+0x3fce070
	struct TArray<struct FVector> GetVertexInstanceNormals(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceNormals // (Final|Native|Public|Const) // @ game+0x3fce040
	struct TArray<struct FColor> GetVertexInstanceColors(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetVertexInstanceColors // (Final|Native|Public|Const) // @ game+0x3fcdfb0
	struct TArray<struct FIntVector> GetTriangleIndices(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetTriangleIndices // (Final|Native|Public|Const) // @ game+0x3fcdf20
	struct TArray<struct FStaticMaterial> GetStaticMaterials(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetStaticMaterials // (Final|Native|Public|Const) // @ game+0x3fcde90
	uint32_t GetNumVertices(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumVertices // (Final|Native|Public|Const) // @ game+0x3fcde70
	uint32_t GetNumVertexInstances(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumVertexInstances // (Final|Native|Public|Const) // @ game+0x3fcde50
	uint32_t GetNumUVLayers(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumUVLayers // (Final|Native|Public|Const) // @ game+0x3fcde30
	uint32_t GetNumTriangles(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumTriangles // (Final|Native|Public|Const) // @ game+0x3fcde10
	uint32_t GetNumStaticMaterials(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetNumStaticMaterials // (Final|Native|Public|Const) // @ game+0x3fcddf0
	int32_t GetMaterialIndex(struct FName InMaterialSlotName); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetMaterialIndex // (Final|Native|Public|Const) // @ game+0x3fcdd40
	struct TArray<int32_t> GetMaterialIDsPerTriangle(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetMaterialIDsPerTriangle // (Final|Native|Public|Const) // @ game+0x3fcdd10
	struct UMaterialInterface* GetMaterial(int32_t InMaterialIndex); // Function HoudiniEngineRuntime.HoudiniStaticMesh.GetMaterial // (Final|Native|Public) // @ game+0x3fcdc70
	void CalculateTangents(bool bInComputeWeightedNormals); // Function HoudiniEngineRuntime.HoudiniStaticMesh.CalculateTangents // (Final|Native|Public) // @ game+0x3fcdbe0
	void CalculateNormals(bool bInComputeWeightedNormals); // Function HoudiniEngineRuntime.HoudiniStaticMesh.CalculateNormals // (Final|Native|Public) // @ game+0x3fcdb50
	struct FBox CalcBounds(); // Function HoudiniEngineRuntime.HoudiniStaticMesh.CalcBounds // (Final|Native|Public|HasDefaults|Const) // @ game+0x3fcdb00
	uint32_t AddStaticMaterial(struct FStaticMaterial& InStaticMaterial); // Function HoudiniEngineRuntime.HoudiniStaticMesh.AddStaticMaterial // (Final|Native|Public|HasOutParms) // @ game+0x3fcd9e0
};
...
struct UHoudiniStaticMeshComponent : UMeshComponent {
	struct UHoudiniStaticMesh* Mesh; // 0x4d0(0x08)
	struct FBox LocalBounds; // 0x4d8(0x1c)
	bool bHoudiniIconVisible; // 0x4f4(0x01)
	char pad_4F5[0xb]; // 0x4f5(0x0b)

	void SetMesh(struct UHoudiniStaticMesh* InMesh); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.SetMesh // (Final|Native|Public) // @ game+0x3fcf650
	void SetHoudiniIconVisible(bool bInHoudiniIconVisible); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.SetHoudiniIconVisible // (Final|Native|Public) // @ game+0x3fcf5c0
	void NotifyMeshUpdated(); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.NotifyMeshUpdated // (Final|Native|Public) // @ game+0x3fcf5a0
	bool IsHoudiniIconVisible(); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.IsHoudiniIconVisible // (Final|Native|Public|Const) // @ game+0x3fcf580
	struct UHoudiniStaticMesh* GetMesh(); // Function HoudiniEngineRuntime.HoudiniStaticMeshComponent.GetMesh // (Final|Native|Public) // @ game+0x3fcf560
};
